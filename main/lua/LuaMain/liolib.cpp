/*
** $Id: liolib.cpp,v 1.1 2006/02/02 13:36:04 cavac Exp $
...
// Redirect file I/O through the fastopen cache for better SD card performance
#include "../../fastopen.h"
#define fopen fastopen
// fastclose returns void, but standard fclose returns int.
// Wrap it so expressions like (fclose(f) == 0) compile correctly.
static inline int bs_fastclose_int(FILE* f) { fastclose(f); return 0; }
#define fclose bs_fastclose_int
// popen/pclose not available on ESP-IDF
#define USE_POPEN 0
#define popen(f,m) ((FILE*)NULL)
#endif
