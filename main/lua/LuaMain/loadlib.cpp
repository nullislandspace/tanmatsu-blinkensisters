/*
** $Id: loadlib.cpp,v 1.1 2006/02/02 13:36:04 cavac Exp $
...
// On Tanmatsu (ESP32-P4), dynamic loading is not supported.
// Stub out the entire loadlib implementation.
#ifdef TANMATSU_BUILD

static int loadlib(lua_State *L)
{
 lua_pushnil(L);
 lua_pushliteral(L, "`loadlib' not supported on Tanmatsu");
