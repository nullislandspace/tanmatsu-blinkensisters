...
void initMenu() {
	...
	menubg = BS_IMG_Load_Fullscreen(configGetPath("menubg.jpg"),DIE_ON_FILE_ERROR) ;
	menuonlinebg = BS_IMG_Load_Fullscreen(configGetPath("menuonlinebg.jpg"),DIE_ON_FILE_ERROR);
